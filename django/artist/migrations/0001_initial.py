    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_profile', models.ImageField(blank=True, upload_to=artist.models.artist.dynamic_profile_img_path, verbose_name='프로필 이미지')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='like_user_info_list', to='artist.Artist')),
            ],
        ),
    ]
